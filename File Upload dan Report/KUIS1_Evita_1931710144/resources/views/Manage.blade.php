                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$artic->created_at}}</td>
                                    ...
                                    <td> <a href="article/edit/{{ $artic->id }}" class="btn btn-primary btn-radiuszan"style="background-color:#87CEEB">Edit</a> </td>
                                    <td> <a href="article/delete/{{ $artic->id }}" class="btn btn-primary btn-radiuszan"style="background-color:#FF7F50">Hapus</a> </td>
